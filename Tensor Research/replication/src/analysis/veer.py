...
import config
from src.analysis.event_study_multi import _spearman, _two_sided_p, _step_q

EVENT_DIR = config.EVENT_DIR_EXTENDED
FUNDAMENTALS = config.FUNDAMENTALS_FILE
GICS_FILE = config.GICS_FILE
