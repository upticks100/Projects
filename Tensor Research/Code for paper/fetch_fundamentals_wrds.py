...
from pre_prediction_config import LOCAL_GICS_FILE, START_DATE, END_DATE  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=ROOT / "90-25_Q_Fundamentals_v2.csv",
        help="Destination CSV (default: 90-25_Q_Fundamentals_v2.csv next to this script).",
    )
    parser.add_argument(
        "--start-date",
        default=START_DATE,
